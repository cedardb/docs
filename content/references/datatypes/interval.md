...
Intervals are a convenient way for arithmetic on [date]({{< relref "/references/datatypes/date" >}}), [time]({{< relref "/references/datatypes/time" >}}), and [timestamp]({{< relref "/references/datatypes/timestamp" >}}) data.
