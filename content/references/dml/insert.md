...
When inserting many values verbatim, consider using a [copy statement]({{< relref "/references/dml/copy" >}})
...
You can find the full documentation for `on conflict` in the [upsert reference]({{< relref "/references/dml/upsert" >}}).
