...
Upserts allow [inserting]({{< relref "/references/dml/insert" >}}) values into tables with a custom [update]({{< relref "/references/dml/update" >}}) logic that will be applied to
...
expression, including subselects (similar to [Updates]({{< relref "/references/dml/update" >}})).
