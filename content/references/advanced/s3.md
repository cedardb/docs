...
For remote data processing, we recommend using [network optimized instances]({{< relref "/get_started/operate_in_cloud#recommended-ec2-instance-types" >}}) with `50 Gbit/s` or more.
